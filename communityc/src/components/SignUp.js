  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await db.sql`
        INSERT INTO user (firstname, lastname, username, email, phone_number, password, location) 
        VALUES (${firstname}, ${lastname}, ${username}, ${email}, ${phoneNumber}, ${password}, ${location});
      `;
    ...
    <div className="flex items-center justify-center bg-gray-100">
      <div className="w-full max-w-md bg-white p-8 rounded-lg shadow-lg">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="mb-4">
            <label className="required block text-gray-700">Location</label>
            <input
              type="text"
              value={location}
